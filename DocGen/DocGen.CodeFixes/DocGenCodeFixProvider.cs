...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DocGenCodeFixProvider)), Shared]
public class DocGenCodeFixProvider : CodeFixProvider
{
    private const string CodeFixTitle = "Generate documentation";

    public sealed override ImmutableArray<string> FixableDiagnosticIds
    {
        get { return ImmutableArray.Create(DocGenAnalyzer.MethodDiagnosticId); }
    }
